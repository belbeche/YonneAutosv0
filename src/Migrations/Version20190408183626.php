 ...
 */
final class Version20190408183626 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE services_form DROP created_at, CHANGE ouvertures ouvertures DATETIME DEFAULT NULL, CHANGE options ajouts VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE services_form ADD created_at DATETIME DEFAULT NULL, CHANGE ouvertures ouvertures VARCHAR(30) DEFAULT NULL COLLATE utf8mb4_unicode_ci, CHANGE ajouts options VARCHAR(255) DEFAULT NULL COLLATE utf8mb4_unicode_ci');
