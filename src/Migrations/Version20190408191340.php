 ...
 */
final class Version20190408191340 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE services_form DROP open, CHANGE ajouts options VARCHAR(255) DEFAULT NULL COLLATE utf8mb4_unicode_ci');
